...
<html lang="en">
    <head>
        ...
        <title>CSM Training & Consulting | Education Program</title>
    </head>
    <body>
        <!-- Nav Bar -->
        ...
        <!-- Education -->
        <section class="container-fluid mt-0 text-center section-training">
            <div class="py-4">
                <div class="row">
                ...
                <div class="row mx-4 text-white">
                        ...
                        <div class="lesson-wrap">
                            <a class="text-center" href="#" id="lesson-btn">
                                <div class="lesson-wrap-1 my-3">
                                    <a class="sub-program-icon" href="#"><i class="fa fa-graduation-cap"></i></a>
                                    <h1>Teen's Academy</h1>
                                </div>
                            </a>
                        </div>
                    </div>
                    <div class ="col-md-6">
                        <div class="lesson-wrap">
                            <a class="text-center" href="#" id="lesson-btn">
                                <div class="lesson-wrap-1 my-3">
                                    <a class="sub-program-icon" href="#"><i class="fa fa-group"></i></a>
                                    <h1>Parenting</h1>
                                </div>
                            </a>
                        </div>
